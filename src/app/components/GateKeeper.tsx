...
const Gatekeeper: React.FC = () => {
  ...
  return (
    <section id="gatekeeper" className="py-24 px-6 max-w-4xl mx-auto relative z-10">
      <div className="border border-white/10 bg-white/2 backdrop-blur-sm p-8 md:p-12 rounded-2xl">
        ...
        {!assessment ? (
          ...
          <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
            <div className={`inline-flex items-center gap-2 px-4 py-2 rounded-full border ${assessment.alignment === 'High' ? 'border-emerald-500/30 bg-emerald-500/5 text-emerald-400' :
