        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-1">
            {[
              ...
              <div key={i} className="group p-10 border border-white/5 hover:bg-white/2 transition-colors relative overflow-hidden">
                ...
                <div className="mt-8 h-px w-0 group-hover:w-full bg-indigo-500 transition-all duration-700" />
              </div>
            ))}
          </div>
        </div>
